...
(function( exports, $ ){
	...
	api.Control = api.Class.extend(/** @lends wp.customize.Control.prototype */{
		...
		renderNotifications: function() {
			...
			container.empty().append( control.notificationsTemplate( { notifications: notifications, altNotice: Boolean( control.altNotice ) } ).trim() );
		},
